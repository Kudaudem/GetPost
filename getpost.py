...
client = Client("getpost", api_id, api_hash, client) #если хотите сменить аккаунт, смените getpost на любое другое слово или просто удалите .session файл в папке со скриптом
